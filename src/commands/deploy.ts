...
export const args = {
  ...
  "--allow-problems": { type: Boolean, alias: "--allow-issues", description: "Deploy even with problems" },
  "--allow-charges": { type: Boolean, description: "Deploy even with new charges" },
  "--allow-data-delete": { type: Boolean, description: "Deploy even with data loss" },
};
