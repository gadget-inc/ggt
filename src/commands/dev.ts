...
export const args = {
  ...SyncJsonArgs,
  ...LoggingArgs,
  "--prefer": { type: MergeConflictPreferenceArg, description: "Conflict resolution preference (local or environment)" },
  "--file-push-delay": { type: Number, default: ms("100ms"), description: "Delay in ms before pushing file changes" },
  "--file-watch-debounce": { type: Number, default: ms("300ms"), description: "Debounce in ms for file watch events" },
  "--file-watch-poll-interval": { type: Number, default: ms("3s"), description: "Interval in ms for polling file changes" },
  "--file-watch-poll-timeout": { type: Number, default: ms("20s"), description: "Timeout in ms for file watch polling" },
  "--file-watch-rename-timeout": { type: Number, default: ms("1.25s"), description: "Timeout in ms for detecting file renames" },
